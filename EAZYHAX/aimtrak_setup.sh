...
elif [[ ! -f "/home/pi/RetroPie/roms/mame-advmame/le2.zip" ]]; then
	wget http://eazyhax.com/pitime/shooter/le2.zip
elif [[ ! -f "/home/pi/RetroPie/roms/mame-advmame/duckhunt.zip" ]]; then
	wget http://eazyhax.com/pitime/shooter/duckhunt.zip
fi

echo "All done. Enjoy and remember....One shot one kill!"
